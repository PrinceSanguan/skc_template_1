      ...
      <div className="container relative mx-auto px-4 z-10">
          ...
          {locations.map((location) => (
            ...
            >
              <div className="relative mb-4">
                ...
                <h3 className="ml-10 text-xl font-semibold text-white group-hover:text-red-400 transition-colors duration-300">{location.name}</h3>
              </div>
              ...
              <div className="mb-5 pl-2 border-l-2 border-red-900/30 group-hover:border-red-500/50 transition-colors duration-300">
                ...
                <p className="text-gray-300">{location.city}, {location.state} {location.zip}</p>
              ...
              <div className="mb-6">
                <h4 className="mb-3 font-medium text-white flex items-center">
                  <svg className="mr-2 h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex space-x-3">
                <Button 
                  variant="default" 
                  className="flex-1 bg-gradient-to-r from-red-700 to-red-600 text-white hover:from-red-600 hover:to-red-500 transition-all duration-300 shadow-md"
                >
                ...
                <Button 
                  variant="outline" 
                  className="flex-1 border-red-600/30 text-red-500 hover:bg-red-900/20 hover:border-red-500/50 transition-all duration-300"
                >
                  <span className="flex items-center">
                    <svg className="mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-16 text-center">
          <p className="mb-6 text-gray-300">
            Email us at <a href="mailto:skc@goskc.com" className="text-red-400 hover:text-red-300 transition-colors duration-300 font-medium hover:underline">skc@goskc.com</a> for more information or to schedule a tour.
          </p>
          <Button 
            variant="outline" 
            className="rounded-xl border-red-600/30 px-8 py-4 text-red-400 hover:bg-red-900/20 hover:border-red-500/50 transition-all duration-300 shadow-lg shadow-red-900/20 transform hover:scale-105 group"
          >
            <span className="flex items-center">
              ...
              <svg className="ml-2 h-5 w-5 transform transition-transform duration-300 group-hover:translate-x-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
