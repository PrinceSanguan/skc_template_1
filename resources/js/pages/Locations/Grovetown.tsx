        ...
        <div className="mb-16 relative">
          ...
          <div className="relative z-10 py-12 px-8">
            <AnimatedElement type="fadeIn" delay={0.2}>
              <h1 className="text-5xl font-bold text-center mb-4 text-white drop-shadow-md">Grovetown, GA Location</h1>
            </AnimatedElement>

            <AnimatedElement type="fadeIn" delay={0.3}>
              <p className="text-xl text-center text-gray-200 mb-8 max-w-3xl mx-auto font-light leading-relaxed">
                Nestled in the Central Savannah River Area (CSRA), our Grovetown dojo provides
        ...
        <AnimatedElement type="fadeIn" delay={0.5}>
          <div className="mb-20">
            <div className="flex flex-col items-center mb-10">
              <h2 className="text-3xl font-bold text-center mb-2">About Our Grovetown Location</h2>
          ...
          <div className="bg-gradient-to-r from-red-800 to-red-900 rounded-xl p-10 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white text-lg mb-10 max-w-2xl mx-auto">
                Join us at Seigler's Karate Center in Grovetown and discover the transformative power of
