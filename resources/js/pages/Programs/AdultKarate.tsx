...
export default function AdultKarate() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Develop strength, flexibility, coordination, and cardiovascular endurance through diverse training.",
      icon: (
        <svg
          className="w-10 h-10 text-red-500"
          fill="none"
          ...
          <AnimatedElement>
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg mb-6">
                Our Adult Kempo Karate program blends traditional martial arts wisdom with modern, practical
                self-defense techniques. This comprehensive system incorporates strikes, kicks, blocks, joint locks,
                throws, and ground defense to create well-rounded martial artists.
              </p>
              <p className="text-lg mb-6">
                Classes are designed to challenge participants physically while fostering mental discipline and
                emotional balance. Our supportive environment allows adults of all fitness levels to progress at their
                own pace while continuously improving their skills.
              </p>
              <p className="text-lg">
                Whether you're seeking self-defense capabilities, physical fitness, stress relief, or personal growth,
                our Adult Kempo Karate program offers a path to achieving your goals under the guidance of experienced
                instructors.
              </p>
            </div>
          </AnimatedElement>
                ...
                {beltProgression.map((belt, index) => (
                  <div key={index} className="bg-white p-6 rounded-lg shadow-md flex items-center">
                    <div
                      ...
                      style={{
                        backgroundColor: belt.color.toLowerCase().includes("white")
                          ? "#f9fafb"
                          : belt.color.toLowerCase().includes("yellow")
                            ? "#fef3c7"
                            : belt.color.toLowerCase().includes("orange")
                              ? "#ffba08"
                              : belt.color.toLowerCase().includes("purple")
                                ? "#8b5cf6"
                                : belt.color.toLowerCase().includes("blue")
                                  ? "#3b82f6"
                                  : belt.color.toLowerCase().includes("green")
                                    ? "#10b981"
                                    : belt.color.toLowerCase().includes("brown")
                                      ? "#92400e"
                                      : "#111827",
                        border: belt.color.toLowerCase().includes("white")
                          ? "1px solid #e5e7eb"
                          : belt.color.toLowerCase().includes("yellow")
                            ? "1px solid #fbbf24"
                            : "none",
          ...
          <AnimatedElement>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="mb-6">
                ...
                <p>
                  Dynamic stretching, cardiovascular conditioning, and basic movement patterns to prepare the body for
                  training.
                </p>
              </div>
              <div className="mb-6">
                ...
                <p>
                  Practice of fundamental strikes, blocks, kicks, and stances, with focus on proper form and execution.
                </p>
              </div>
              <div className="mb-6">
                <h3 className="text-xl font-semibold mb-2">Combinations & Applications (15 minutes)</h3>
                <p>
                  Learning to combine techniques into effective sequences and practicing practical self-defense
                  applications.
                </p>
              </div>
              <div className="mb-6">
                ...
                <p>
                  Traditional patterns of movement that encode combat principles and develop focus, memory, and
                  precision.
                </p>
              </div>
              <div>
                ...
                <p>
                  Strength and endurance exercises followed by static stretching to improve flexibility and reduce
                  muscle tension.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="mt-6 text-gray-600">
                  Beginners can wear comfortable athletic clothing for their first few classes until they purchase a
                  uniform.
                </p>
              </div>
            </div>
