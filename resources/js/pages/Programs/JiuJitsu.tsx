...
export default function JiuJitsu() {
  ...
  const [modalType, setModalType] = useState<"schedule" | "pricing">("schedule")

  // Function to open modal
  const openModal = (e: React.MouseEvent<HTMLAnchorElement>, type: "schedule" | "pricing") => {
    e.preventDefault()
    setModalType(type)
    setIsModalOpen(true)
  }
      ...
      <AnimatedElement type="fadeIn" delay={0.35}>
        <div className="mb-16 rounded-xl overflow-hidden relative">
          ...
          <div className="relative z-10 p-4 sm:p-6 md:p-8 text-center">
            ...
            <a
              href="#"
              onClick={(e) => openModal(e, "schedule")}
        ...
        <AnimatedElement type="fadeIn" delay={0.8}>
          <div className="relative rounded-xl overflow-hidden mb-8">
            ...
            <div className="relative z-10 p-6 sm:p-8 md:p-10 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">Begin Your Jiu Jitsu Journey</h2>
